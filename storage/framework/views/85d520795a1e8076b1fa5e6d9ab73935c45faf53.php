...
<html lang="en" dir="ltr">
  <head>
    <meta charset="UTF-8">
    <link rel="stylesheet" href="<?php echo e(asset('css/styleini.css')); ?>">
...
<body>
  <div class="container">
    ...
    <div class="cover">
      <div class="front">
        <img src="<?php echo e(asset('img/chrome-3263652_1920.jpg')); ?>" alt="">
      </div>
      <div class="back">
        <img class="backImg" src="<?php echo e(asset('img/backImg.jpg')); ?>" alt="">
        <div class="text">
...
<?php /**PATH C:\Users\luisr\OneDrive\Escritorio\Paginas\example-app\resources\views/iniciose.blade.php ENDPATH**/ ?>